...
import { CursorMinimal, Hand, Shapes, Brush, FillHalf, Minus } from 'pixelarticons/react';
    ...
    <div className="flex flex-col py-2 gap-4 absolute h-fill-available m-6 bg-[#171717] z-10">
      <div className="flex flex-col gap-2 px-2">
        ...
        <button 
          ...
          className={`flex items-center justify-center w-12 h-12 hover:bg-[#8354E0] ${activeTool === 'pencil' ? 'bg-[#8354E0] text-white' : 'text-[#737373]'} hover:text-white transition-colors`}
          title="Pencil"
        >
